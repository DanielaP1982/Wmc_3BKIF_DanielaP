...
async function fetchRadioStations() {
    ...
    try {
        ...
        const response = await fetch("https://all.api.radio-browser.info/json/stations/search?tagList=dance,trance,techno&limit=10&hidebroken=true&order=clickcount&reverse=true&bitratemin=128");
